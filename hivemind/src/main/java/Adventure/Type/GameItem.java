...
public class GameItem implements Serializable{
    ...
    public GameItem(int id, String name, String description, String examine) {
        this.id = id;
        this.name = name;
    ...
    public GameItem(int id, String name, String description, String examine, Set<String> alias) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.examine = examine;
    ...
    public GameItem(int id, String name, String description, String examine, Set<String> alias, int contained) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.examine = examine;
